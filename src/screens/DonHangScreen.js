  ...
  return (
    <ScrollView contentContainerStyle={styles.scrollView}>
      ...
      <View style={styles.homemain}>
        ...
        <Text style={[styles.spGoiY, styles.spGoiYTypo]}>Sản phẩm gợi ý</Text>
        ...
        <View style={styles.thanhtoancontainer}>
          ...
          <Text style={[styles.tongthanhToan, styles.tongthanhToanPosition]}>
            Tổng thanh toán
          </Text>
          <View
            style={[styles.thanhtoancontainerChild, styles.plusItemLayout]}
          />
