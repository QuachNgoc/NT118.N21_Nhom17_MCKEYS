...
const CardMuaNgay = ({ style }) => {
  return (
    <View style={[styles.mnN, styles.mnNLayout, style]}>
      ...
      />
      <Text style={styles.mnNRt}>Món ăn rất ngon số 1</Text>
      <Text style={[styles.text, styles.textTypo]}>99.000 đ</Text>
      <View style={[styles.buybtn, styles.textPosition]}>
        <Image
        ...
        <Image
          style={[styles.iconfeatherIcon, styles.iconfeatherIconLayout1]}
          resizeMode="cover"
          source={require("../../assets/images/buybtn.svg")}
        />
      </View>
    </View>
  );
